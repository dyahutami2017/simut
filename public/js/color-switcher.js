...
jQuery(document).ready(function($) {
	...
	$("ul.colors .color1" ).click(function(){
		...
		$("#logo-ugm" ).attr("src", "img/logo-ugm/logo-ugm-preset.png" );
		return false;
	});	

	$("ul.colors .color2" ).click(function(){
		$("#colors" ).attr("href", "css/colors/blue.css" );
		$("#logo-ugm" ).attr("src", "img/logo-ugm/logo-ugm-blue.png" );
		return false;
	});	

	$("ul.colors .color3" ).click(function(){
		$("#colors" ).attr("href", "css/colors/turquoise.css" );
		$("#logo-ugm" ).attr("src", "img/logo-ugm/logo-ugm-turquoise.png" );
		return false;
	});

	$("ul.colors .color4" ).click(function(){
		$("#colors" ).attr("href", "css/colors/orange.css" );
		$("#logo-ugm" ).attr("src", "img/logo-ugm/logo-ugm-orange.png" );
		return false;
	});

	$("ul.colors .color5" ).click(function(){
		$("#colors" ).attr("href", "css/colors/wisteria.css" );
		$("#logo-ugm" ).attr("src", "img/logo-ugm/logo-ugm-wisteria.png" );
		return false;
	});	

	$("ul.colors .color6" ).click(function(){
		$("#colors" ).attr("href", "css/colors/alizarin.css" );
		$("#logo-ugm" ).attr("src", "img/logo-ugm/logo-ugm-alizarin.png" );
		return false;
	});
